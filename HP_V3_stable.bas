...
'check for log reporting
    If (more_instructions = "Log_Report") Then
        DO_Check_HP_A_Table_V1 = "DO_Check_HP_A_Table_V1 - Public - Stable - no help file"
        Exit Function
    End If
'code start
...
Public Function Get_size_HP_B_V1(Optional more_instructions As String) As Variant
        ...
        'check for log reporting
            If (more_instructions = "Log_Report") Then
                Get_size_HP_B_V1 = "Get_size_HP_B_V1 - Public - Stable with logs 11/11/2020 - no help log"
                Exit Function
            End If
        'code start
